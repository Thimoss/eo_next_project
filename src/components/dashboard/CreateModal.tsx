  ...
  return (
    <Modal onClose={() => setOpen(false)} open={open}>
      <div className="flex flex-col gap-5">
        <span className="text-sm font-bold text-left">Add Document</span>
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
          ...
          >
            <button
              ...
              type="button"
              className="px-3 py-1.5 rounded-md text-xs font-semibold text-white duration-300 bg-primaryRed disabled:bg-primaryRedLighter hover:bg-primaryRedDarker cursor-pointer flex items-center justify-between flex items-center justify-between"
            >
              Cancel
            </button>
            <button
