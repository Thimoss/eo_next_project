...
export default function CreateModalItem({
  ...
  const {
    ...
    defaultValues: {
      ...
      listOffer: [{ materialPricePerUnit: 0, feePricePerUnit: 0 }],
    },
  });
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                Lengkapi detail pekerjaan untuk sektor{" "}
                {selectedSector?.name}.
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <label className="flex items-center gap-2 text-sm font-semibold text-gray-700">
                  <input
                    ...
                    className="h-4 w-4 rounded border-gray-300 text-primaryGreen focus:ring-primaryGreen/30"
                  />
                  Single Item
                </label>
              </div>
